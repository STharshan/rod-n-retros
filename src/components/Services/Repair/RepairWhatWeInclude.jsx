          ...
          {cardItems.map((item, index) => (
            <div
              ...
              className="bg-card text-card-foreground flex flex-col gap-6 rounded-xl 
                         border border-transparent shadow-md transition-all duration-300 ease-out
...
export default RepairWhatWeInclude;
