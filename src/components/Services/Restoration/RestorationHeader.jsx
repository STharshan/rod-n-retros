        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-18">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-[#8b1a1a] font-medium">Complete Vehicle Restoration</p>
              <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
                Our full restoration service brings classic vehicles back to their original glory and beyond. From frame-off restorations to comprehensive mechanical rebuilds, we handle every aspect of your classic car's restoration with meticulous attention to detail.
              </p>
            </div>
