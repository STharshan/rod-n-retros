        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-18">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-[#8b1a1a] font-medium">Structural Repair & Custom Work</p>
              <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
                Our expert welding and fabrication services handle everything from structural repairs to custom modifications. With decades of experience in automotive metalwork, we provide strong, reliable solutions for all your welding needs.
              </p>
            </div>
