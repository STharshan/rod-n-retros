        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-18">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-[#8b1a1a] font-medium">Complete Paint Restoration</p>
              <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
                Our bare metal respray service provides the ultimate paint restoration for your classic vehicle. We strip everything back to bare metal, treat any rust or imperfections, and apply a professional-grade paint system that will last for decades.
              </p>
            </div>
...
export default BareMetalResprays;
